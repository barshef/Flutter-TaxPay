    ...
    public static class HashPasswordHelper
    {
        ...
        public static string GeneratePassword(int length) //length of salt    
        {
            ...
            for (var i = 0; i <= length - 1; i++)
            {
                ...
                do
                {
                    count = Convert.ToInt32((allowedChars.Length) * randNum.NextDouble());
                } while (count > allowedChars.Length);
                //if (count>allowedChars.Length)
                //chars[i] = allowedChars[Convert.ToInt32((allowedChars.Length) * randNum.NextDouble())];
                chars[i] = allowedChars[count];
            }
        ...
        public static string GetUniqueKey(int maxSize)
        {
            ...
            //chars = "abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNOPQRSTUVWXYZ0123456789".ToCharArray();
            chars = "ABCDEFGHJKLMNOPQRSTUVWXYZ0123456789".ToCharArray();
            var data = new byte[1];
